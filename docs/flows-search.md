# Flows search (marketplace + workspace reuse)
...
- Agents building flows should be able to quickly find “good patterns” (approved marketplace flows) plus relevant flows in their current workspace.
...
- `--scope all` (public marketplace flows + current workspace flows)
- `--limit 20`
