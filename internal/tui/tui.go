...
func (m Model) renderDashboard(bodyH int) string {
	...
	return lipgloss.JoinVertical(lipgloss.Left,
		lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Dashboard"),
		rule(m.width),
		statsLine,
		shortcutsLine,
		"",
		lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Navigate"),
		"",
		"  f  flows",
		"  r  runs",
		"  m  marketplace",
...
func (m Model) renderStep() string {
	...
	lines := []string{
		lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Step"),
		fmt.Sprintf("flow: %s", f.Slug),
		fmt.Sprintf("step: %s (%s)", step.ID, step.Type),
		"",
		lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Definition"),
		step.Definition,
		"",
		lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Input (concrete)"),
		prettyJSON(input),
		"",
...
func (m Model) renderFlowLeftPane() string {
	...
	headerLines := []string{
		lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render(f.Name),
...
func (m Model) renderRunLeftPane() string {
	...
	headerLines := []string{
		lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Run " + r.WorkflowID),
		...
		"",
		lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Steps"),
	}
	for i := range headerLines {
		headerLines[i] = truncateRunes(headerLines[i], w)
	}
...
func (m Model) renderFlowFocusedStepDetail() string {
	...
	b.WriteString(lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Definition"))
	b.WriteString("\n")
	b.WriteString(step.Definition)
	b.WriteString("\n\n")

	b.WriteString(lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Input (concrete)"))
	b.WriteString("\n")
	b.WriteString(prettyJSON(input))
	b.WriteString("\n\n")

	b.WriteString(lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Output (concrete)"))
	b.WriteString("\n")
...
func renderFlowStructureDetail(line string) string {
	...
	case strings.Contains(l, "trigger"):
		b.WriteString(lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Trigger"))
		b.WriteString("\n")
		b.WriteString(meta.Render("This is a structural node (non-executable)."))
		b.WriteString("\n\n")
		b.WriteString(lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Spine"))
		b.WriteString("\n")
		b.WriteString(s)
	case strings.Contains(l, "branch"):
		b.WriteString(lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Branch"))
		b.WriteString("\n")
	...
	case strings.Contains(l, "parallel"):
		b.WriteString(lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Parallel"))
		b.WriteString("\n")
	...
	case strings.Contains(l, "join"):
		b.WriteString(lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Join"))
		b.WriteString("\n")
	...
	case strings.Contains(l, "loop") || strings.Contains(s, "╭") || strings.Contains(s, "╰"):
		b.WriteString(lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Loop"))
		b.WriteString("\n")
		...
		b.WriteString(s)
	default:
		b.WriteString(lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Structure"))
		b.WriteString("\n")
...
func (m Model) renderRunFocusedStepDetail() string {
	...
	if exec.Error != "" {
		b.WriteString(lipgloss.NewStyle().Foreground(breytaDanger).Bold(true).Render(exec.Error))
		b.WriteString("\n\n")
	}

	b.WriteString(lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Input"))
	b.WriteString("\n")
	b.WriteString(prettyJSON(exec.InputPreview))
	b.WriteString("\n\n")

	b.WriteString(lipgloss.NewStyle().Bold(true).Foreground(breytaTextColor).Render("Output"))
	b.WriteString("\n")
...
func (d minimalDelegate) Render(w io.Writer, m list.Model, index int, item list.Item) {
	...
	titleStyle := lipgloss.NewStyle().Foreground(breytaTextColor)
	if selected {
