...
- primitive-first ladder:
  ...
  - when copying overall flow structure, prefer ` + "`breyta flows templates duplicate <template-slug>`" + ` over raw-definition copy/paste; raw-definition output is normalized inspection data, while ` + "`breyta flows pull <slug>`" + ` preserves editable workspace formatting
