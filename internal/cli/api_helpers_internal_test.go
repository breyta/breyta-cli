...
func TestServerRecoveryActionsUseRetainedWorkspaceRoutes(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "https://example.test/breyta/ws-acme/flows/daily-report",
		},
		{
			...
			want: "https://example.test/breyta/ws-acme/connections/conn-123/edit",
		},
		{
...
func TestServerRecoveryActionsPreserveReverseProxyPrefix(t *testing.T) {
	...
	want := "https://example.test/flows/ws-acme/flows/daily-report"
