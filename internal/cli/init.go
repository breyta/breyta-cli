...
- Use ` + "`breyta flows public publish <slug>`" + ` or ` + "`breyta flows public delist <slug>`" + ` when moving a flow onto or off all public surfaces together; use lower-level Discover/marketplace update commands only for intentional single-flag changes
