...
6. Include workspace-wide installed-app inventory when it matters: ` + "`breyta flows installations list --all`" + `; for one flow, use ` + "`breyta flows installations list <flow-slug> --all`" + `.
